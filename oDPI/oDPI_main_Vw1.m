...
data1 = data.EXPVtau8Vw0Vth0Csyn1_;
data2 = data.EXPVtau8Vw5Vth0Csyn1_;
data3 = data.EXPVtau8Vw10Vth0Csyn1_;
...
Csyn = 1; Cgd_list = [0.4,0.8,0.8];% nF
...
time_sft = [8.5-5.049-0.2,18.6+10.1-5.049-0.45,12.1-5.049-0.2];
