...
Exp1 = data.ExpVdd10Iin100Cmem4pt7Cfb100_;
...
exper=Exp1(1:end,3);
error = immse(Vout(1:13000,2),exper(1:13000));
disp(['error = ',num2str(error)]);
error1 = error/immse(zeros(13000,1),exper(1:13000));
...
exper=Exp1(1:end,2);
error = immse(Vmem(1:13000,2),exper(1:13000));
disp(['error = ',num2str(error)]);
error1 = error/immse(zeros(13000,1),exper(1:13000));
disp(['error1 = ',num2str(error1)]);
hold off;
...
opt.FileName = 'figs/oAH_exp2.eps'; 
% create the plot
setPlotProp5(opt);