...
Exp1 = data.ExpVdd10Iin100Cmem47Cfb100_;
...
exper=Exp1(1:end,3);
error = immse(Vout(18200:35000,2),exper(18200:35000));
disp(['error = ',num2str(error)]);
error1 = error/immse(zeros(16801,1),exper(18200:35000));
...
exper=Exp1(1:end,2);
error = immse(Vmem(18200:35000,2),exper(18200:35000));
error1 = error/immse(zeros(16801,1),exper(18200:35000));
disp(['error = ',num2str(error)]);
disp(['error1 = ',num2str(error1)]);
hold off;
...
opt.FileName = 'figs/oAH_exp3.eps'; 
% create the plot
setPlotProp5(opt);